...
class BoardFactory {
    ...
    fun createRetiredChessBoard():Board {
            val board = Board(HashMap(), 8, 8)
    ...
    fun chancellorChess() : Board{
        val board = Board(HashMap(), 8, 10)
        ...
        board.put(Position(1, 2), PieceImpl(Color.WHITE, Type.KNIGHT, listOf(ComposeMovement(listOf(JumpMove(2, 2, 1, 1))), ComposeMovement(listOf(JumpMove(1, 1, 2, 2))))))
        board.put(Position(1, 3), PieceImpl(Color.WHITE, Type.BISHOP, listOf(ComposeMovement(listOf(DiagonalMovement(8, 8, 8, 8),DiagonalTrepassinStrategy())))))
        board.put(Position(1, 4), PieceImpl(Color.WHITE, Type.CHANCELLOR, listOf(ComposeMovement(listOf(JumpMove(2, 2, 1, 1))), ComposeMovement(listOf(JumpMove(1, 1, 2, 2))),ComposeMovement(listOf(HorizontalAndVerticalMovement(8, 8, 8, 8),HorizontalTrepassinValidator())))))
        board.put(Position(1, 5), PieceImpl(Color.WHITE, Type.QUEEN, listOf(ComposeMovement(listOf(DiagonalMovement(8, 8, 8, 8),DiagonalTrepassinStrategy())),ComposeMovement(listOf(HorizontalAndVerticalMovement(8, 8, 8, 8),HorizontalTrepassinValidator())))))
        board.put(Position(1, 6), PieceImpl(Color.WHITE, Type.FRSTKING, listOf(ComposeMovement(listOf(HorizontalAndVerticalMovement(2, 2, 1, 1),HorizontalTrepassinValidator())),ComposeMovement(listOf(DiagonalMovement(1, 1, 1, 1),DiagonalTrepassinStrategy())))))
        board.put(Position(1, 7), PieceImpl(Color.WHITE, Type.CHANCELLOR, listOf(ComposeMovement(listOf(JumpMove(2, 2, 1, 1))), ComposeMovement(listOf(JumpMove(1, 1, 2, 2))),ComposeMovement(listOf(HorizontalAndVerticalMovement(8, 8, 8, 8),HorizontalTrepassinValidator())))))
        board.put(Position(1, 8), PieceImpl(Color.WHITE, Type.BISHOP, listOf(ComposeMovement(listOf(DiagonalMovement(8, 8, 8, 8),DiagonalTrepassinStrategy())))))
        board.put(Position(1, 9), PieceImpl(Color.WHITE, Type.KNIGHT,listOf(ComposeMovement(listOf(JumpMove(2, 2, 1, 1))), ComposeMovement(listOf(JumpMove(1, 1, 2, 2))))))
        board.put(Position(1, 10), PieceImpl(Color.WHITE, Type.FIRSTTOWER, listOf(ComposeMovement(listOf(HorizontalAndVerticalMovement(8, 8, 8, 8),HorizontalTrepassinValidator())))))
        for (i in 1..10) {
            board.put(Position(2, i), PieceImpl(Color.WHITE, Type.FIRSTPAWN, listOf(ComposeMovement(listOf(DiagonalMovement(1, 1, 1, 0))), ComposeMovement(listOf(HorizontalAndVerticalMovement(0, 0, 2, 0))))))
        }
        ...
        board.put(Position(8, 2), PieceImpl(Color.BLACK, Type.KNIGHT, listOf(ComposeMovement(listOf(JumpMove(2, 2, 1, 1))), ComposeMovement(listOf(JumpMove(1, 1, 2, 2))))))
        board.put(Position(8, 3), PieceImpl(Color.BLACK, Type.BISHOP, listOf(ComposeMovement(listOf(DiagonalMovement(8, 8, 8, 8),DiagonalTrepassinStrategy())))))
        board.put(Position(8, 4), PieceImpl(Color.BLACK, Type.CHANCELLOR, listOf(ComposeMovement(listOf(JumpMove(2, 2, 1, 1))), ComposeMovement(listOf(JumpMove(1, 1, 2, 2))),ComposeMovement(listOf(HorizontalAndVerticalMovement(8, 8, 8, 8),HorizontalTrepassinValidator())))))
        board.put(Position(8, 5), PieceImpl(Color.BLACK, Type.QUEEN, listOf(ComposeMovement(listOf(DiagonalMovement(8, 8, 8, 8),DiagonalTrepassinStrategy())),ComposeMovement(listOf(HorizontalAndVerticalMovement(8, 8, 8, 8),HorizontalTrepassinValidator())))))
        board.put(Position(8, 6), PieceImpl(Color.BLACK, Type.FRSTKING, listOf(ComposeMovement(listOf(HorizontalAndVerticalMovement(2, 2, 1, 1),HorizontalTrepassinValidator())),ComposeMovement(listOf(DiagonalMovement(1, 1, 1, 1),DiagonalTrepassinStrategy())))))
        board.put(Position(8, 7), PieceImpl(Color.BLACK, Type.CHANCELLOR, listOf(ComposeMovement(listOf(JumpMove(2, 2, 1, 1))), ComposeMovement(listOf(JumpMove(1, 1, 2, 2))),ComposeMovement(listOf(HorizontalAndVerticalMovement(8, 8, 8, 8),HorizontalTrepassinValidator())))))
        board.put(Position(8, 8), PieceImpl(Color.BLACK, Type.BISHOP, listOf(ComposeMovement(listOf(DiagonalMovement(8, 8, 8, 8),DiagonalTrepassinStrategy())))))
        board.put(Position(8, 9), PieceImpl(Color.BLACK, Type.KNIGHT, listOf(ComposeMovement(listOf(JumpMove(2, 2, 1, 1))), ComposeMovement(listOf(JumpMove(1, 1, 2, 2))))))
        board.put(Position(8, 10), PieceImpl(Color.BLACK, Type.FIRSTTOWER, listOf(ComposeMovement(listOf(HorizontalAndVerticalMovement(8, 8, 8, 8),HorizontalTrepassinValidator())))))
        for (i in 1..10) {
            board.put(Position(7, i), PieceImpl(Color.BLACK, Type.FIRSTPAWN, listOf(ComposeMovement(listOf(DiagonalMovement(1, 1, 0, 1))), ComposeMovement(listOf(HorizontalAndVerticalMovement(0, 0, 0, 2))))))
        }
